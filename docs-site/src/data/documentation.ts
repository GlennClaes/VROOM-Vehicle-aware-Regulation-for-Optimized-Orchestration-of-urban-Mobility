...
export interface DefinitionOfDoneGroup {
  title: string
  checks: string[]
}
...
export interface ProcessRitual {
  title: string
  text: string
}
...
const assetBase: string = `${import.meta.env.BASE_URL}project-media/`
...
export const headerFacts: HeaderFact[] = [
  {
    label: 'Team',
    value: 'AIN3',
...
export const requirementFit: RequirementRow[] = [
  {
...
export const deliverables: IconCard[] = [
  {
...
export const definitionOfDone: DefinitionOfDoneGroup[] = [
  {
...
export const literatureSources: string[] = [
...
export const simulationFlow: SimulationStep[] = [
  {
    step: '01',
...
export const uiWorkflows: IconCard[] = [
  {
...
export const productionReadiness: IconCard[] = [
  {
...
export const productionFiles: ProductionFileRow[] = [
...
export const sprintTimeline: SprintEntry[] = [
  {
    sprint: 'Sprint 0',
...
export const processRituals: ProcessRitual[] = [
  {
...
export const pipelines: IconCard[] = [
  {
...
export const futureOptimization: IconCard[] = [
  {
...
export const assetCards: IconCard[] = [
  {
